package com.negk.lerna.data.repository
...
class GameRepository(
    ...
    private val gameJsonProvider: GameJsonProvider
) {
     ...
     */
    suspend fun syncGamesFromJson() {
        val gamesJsonString = gameJsonProvider.getGamesJsonString()
        JsonDataPopulator.populateGames(gamesJsonString, gameDao)
    }
}
